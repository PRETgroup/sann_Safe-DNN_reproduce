...
{
    scanf("%lf %lf %lf %lf %lf %lf %lf %lf %lf %lf", &tmp_input[0], &tmp_input[1], &tmp_input[2], &tmp_input[3], &tmp_input[4], &tmp_input[5], &tmp_input[6], &tmp_input[7], &tmp_input[8], &tmp_input[9]);
