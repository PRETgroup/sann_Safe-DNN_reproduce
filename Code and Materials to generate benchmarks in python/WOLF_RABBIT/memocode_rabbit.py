...
Data_l = {'data1': [1, 1],'data2': [0, 1], 'data3': [1, 0], 'data4': [1, 1]}
labels = DataFrame (Data_l, columns = ['data1','data2', 'data3', 'data4'])

model = Sequential()
model.add(Dense(24, input_dim=20, activation='sigmoid'))
...
with open("memocode_rabbit.json", "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
model.save_weights("memocode_rabbit.h5")
