...
// MNN I/O shapes
#define MNN_INPUT_DIM_0 28
#define MNN_INPUT_DIM_1 28
#define MNN_INPUT_DIM_2 1
...
typedef struct
{
    NN_NUM_TYPE inputs[NN_META_IN_PL_LEN][MNN_INPUT_DIM_0][MNN_INPUT_DIM_1][MNN_INPUT_DIM_2];
    NN_DATA_DARKNET darknet;
    ...
    // darknet
    int darknet_pl_conn_0_inputs;
    // Output pipelined sources
    int outputs_pl_conn_0_darknet;
