...
{
    scanf("%lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf", &tmp_input[0], &tmp_input[1], &tmp_input[2], &tmp_input[3], &tmp_input[4], &tmp_input[5], &tmp_input[6], &tmp_input[7], &tmp_input[8], &tmp_input[9], &tmp_input[10], &tmp_input[11], &tmp_input[12], &tmp_input[13], &tmp_input[14], &tmp_input[15], &tmp_input[16], &tmp_input[17], &tmp_input[18], &tmp_input[19], &tmp_input[20]);
